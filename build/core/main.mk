...
#[lenovo_fw,jiangsd2,framework_integration_optimized_first_boot] ,"refer to lenovo_fw.txt file" , add
  # Lenovo-sw wuzb1 2015-02-11 enable predex on user build
  ifeq (,$(WITH_DEXPREOPT))
      ifeq ($(user_variant),user)
        ifeq ($(HOST_OS),linux)
          WITH_DEXPREOPT := true
...
#[lenovo_fw,jiangsd2,framework_integration_optimized_first_boot] , end

  # Disallow mock locations by default for user builds
  ADDITIONAL_DEFAULT_PROPERTIES += ro.allow.mock.location=0

else # !user_variant
  #[lenovo_fw,zhusf,disable_kernel_jni_check] , "disable kernel jni check" , add
  # Turn on checkjni for non-user builds.
  # ori
  #  ADDITIONAL_BUILD_PROPERTIES += ro.kernel.android.checkjni=1
  # new
  ADDITIONAL_BUILD_PROPERTIES += ro.kernel.android.checkjni=0
  #[lenovo_fw,zhusf,disable_kernel_jni_check] , end
